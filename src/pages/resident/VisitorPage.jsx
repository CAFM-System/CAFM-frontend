...
export default function VisitorPage() {
  ...
  const filteredVisitors = visitors
    .filter((v) => {
      ...
      const visitorDate = v.visitDate ? getDateOnly(v.visitDate) : null;
  ...
  const stats = {
    ...
    onSite: visitors.filter(v => {
      ...
      return visitorDate === todayStr && !v.isPreRegistered;
      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div>
            ...
            <p className={`${subText} mt-2 text-lg`}>
              Monitor guest arrivals and manage active invitations.
            </p>
          ...
          <div className={`flex items-center gap-4 px-6 py-4 rounded-3xl border shadow-sm ${border} ${cardBg}`}>
            ...
            <div className="flex flex-col">
              ...
              <span className={`text-lg font-bold leading-tight ${text}`}>
                {dateStr}
              </span>
            ...
            >
              ...
              <div className={`relative h-full px-6 py-8 rounded-[14px] flex flex-col items-center text-center gap-4 ${isDarkMode ? "bg-[#18181B]" : "bg-white"}`}>
                ...
                <div>
                  ...
                  <h3 className={`text-xl font-bold ${isDarkMode ? "text-white" : "text-[#18181B]"}`}>
                    Invite New Visitor
                  </h3>

                  <p className={`text-sm mt-1 opacity-80 ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>
                    Generate a new digital entry pass
                  </p>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            <div className={`relative w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-[2.5rem] p-6 md:p-10 border shadow-2xl ${cardBg} ${border}`}>
