...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen relative overflow-hidden">
      ...
      <button
        onClick={toggleTheme}
        className={`absolute top-6 right-6 z-50 p-3 rounded-full backdrop-blur-sm transition-all duration-300 border shadow-lg ${isDarkMode
        ...
        <div className={`hidden md:flex flex-col justify-center space-y-6 px-4 ${theme.textPrimary}`}>
          ...
          <div className="space-y-3 pt-4">
            {[{ icon: Sparkles, text: "Real-time Tracking" }, { icon: TrendingUp, text: "Enhanced Productivity" }, { icon: CheckCircle2, text: "Seamless Integration" }].map((feature, i) => (
              <div key={i} className={`flex items-center gap-3 p-4 rounded-xl border backdrop-blur-md transition-colors duration-300 ${isDarkMode
